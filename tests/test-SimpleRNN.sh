...
INPUT=https://github.com/lwtnn/lwtnn-test-data/raw/v9/simplernn_functional.tgz
ARCH=simplernn_functional.json
VARIABLES=inputs.json
HDF5=simplernn_functional_weights.h5
...
OUTPUT=data/simplernn_functional-out.json
